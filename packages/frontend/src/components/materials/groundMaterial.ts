...
export const createGroundMaterial = (scene: Scene): StandardMaterial => {
    ...
    try {
        ...
        const diffuseTexture = new Texture(getAssetUrl("textures/rocky_terrain", "rocky_terrain_diffuse.jpg"), scene);
        ...
        const normalTexture = new Texture(getAssetUrl("textures/rocky_terrain", "rocky_terrain_normal.jpg"), scene);
        ...
        const aoTexture = new Texture(getAssetUrl("textures/rocky_terrain", "rocky_terrain_ao.jpg"), scene);
        ...
        const specularTexture = new Texture(getAssetUrl("textures/rocky_terrain", "rocky_terrain_spec.jpg"), scene);
